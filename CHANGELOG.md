...
- Added a verified GitHub-hosted release build so updater packages no longer depend on a large local upload.
...
- Added a regression test for the minimum-size top navigation bandroll layout.
